...
#ifdef AUDIOHAL_V4
#define MODEM_T_ENABLE_PROPERTY     "persist.vendor.modem.t.enable"
#define MODEM_W_ENABLE_PROPERTY     "persist.vendor.modem.w.enable"
#define MODEM_TDDCSFB_ENABLE_PROPERTY     "persist.vendor.modem.tl.enable"
#define MODEM_FDDCSFB_ENABLE_PROPERTY     "persist.vendor.modem.lf.enable"
#define MODEM_CSFB_ENABLE_PROPERTY           "persist.vendor.modem.l.enable"
#else
...
typedef struct{
    ...
    /* add for sharkl3 */
    struct route_setting *i2s_fm_bt_loop;
