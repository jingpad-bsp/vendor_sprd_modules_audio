...
LOCAL_CFLAGS += -DAUDIO_USERDEBUG
endif

ifeq ($(SPRD_RECORD_USE_MMAP),true)
LOCAL_CFLAGS += -DRECORD_USE_MMAP
endif
...
ifneq ($(filter $(strip $(PLATFORM_VERSION)),10),)
LOCAL_CFLAGS += -DFM_VOLUME_LEVEL_26
LOCAL_CFLAGS += -DAUDIO_HAL_ANDROID_Q_API
endif
...
ifeq ($(SPRD_DYNAMIC_AUDIO_ENCRYPT),true)
LOCAL_CFLAGS += -DDYNAMIC_AUDIO_ENCRYPT
endif
endif
...
LOCAL_CFLAGS += -DNXP_SMART_PA_HIDL
endif
endif
...
ifeq ($(strip $(AUDIO_HAC_TTY_SUPPORT)),true)
LOCAL_CFLAGS += -DHAC_TTY_SUPPORT
endif
...
LOCAL_SHARED_LIBRARIES += libalsa_adapter
else
LOCAL_SHARED_LIBRARIES += libtinyalsa
ifeq ($(strip $(USE_ALSA_PCM_UTIL_FILE)),true)
LOCAL_SHARED_LIBRARIES += libtinyalsa_utils
endif
endif
...
LOCAL_MODULE := libtinyalsa_utils
LOCAL_32_BIT_ONLY := true
LOCAL_CFLAGS := -D_POSIX_SOURCE -Wno-multichar -g

LOCAL_SRC_FILES := alsa_pcm_util.c
