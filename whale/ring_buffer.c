                                  ...
                                  uint32_t size)
{
    ...
    memcpy((char *)buffer,(char *) ring_buf->buffer + (ring_buf->out & (ring_buf->size - 1)),
           len);
                                  ...
                                  uint32_t size)
{
    ...
    memcpy((char *)ring_buf->buffer + (ring_buf->in & (ring_buf->size - 1)), (char *)buffer,
           len);
    /* then put the rest (if any) at the beginning of the buffer */
    memcpy((char *)ring_buf->buffer, (char *)buffer + len, size - len);
    ring_buf->in += size;
...
/*****************************************************************
    ...
    date         :2015-11-23
*****************************************************************/
uint32_t ring_buffer_len(struct ring_buffer *ring_buf)
{
    uint32_t len = 0;
...
/*****************************************************************
    ...
    date         :2015-11-23
*****************************************************************/
struct ring_buffer *ring_buffer_init(uint32_t size,uint32_t zero_size)
{
    void *buffer = NULL;
