...
#define EQ_PARA_SET_S2_SET_TIMES 20
    ...
    int16_t s_cur_recordeq_para[RECORDEQ_MAX_BAND][5] = {{0},{0},{0},{0},{0},{0}};
     ...
     **---------------------------------------------------------------------------*/
    static void VB_SetHpfMode(UNUSED_ATTR BOOLEAN a)
    {
    }

    static void VB_SetHpfParas(UNUSED_ATTR int16_t a0, UNUSED_ATTR int16_t a1, UNUSED_ATTR int16_t a2, UNUSED_ATTR int16_t a3,
        UNUSED_ATTR int16_t a4, UNUSED_ATTR int16_t a5, UNUSED_ATTR int16_t a6)
    {
    }

    static void VB_SetHpfWidth(UNUSED_ATTR uint16_t width)
    {
    }

    static void  VB_SetHpfGain(UNUSED_ATTR int16_t gIndex, UNUSED_ATTR int16_t gValue)
    {
    }

    static void VB_SwitchHpf(UNUSED_ATTR BOOLEAN is_enable)
    {
    }

    static uint32_t VB_GetHpfGain(UNUSED_ATTR int16_t g_index)
    {
        return 0;
    }

    static void VB_SetHpfLimit(UNUSED_ATTR int8_t limit)
    {
    }
        ...
        int32_t sample_rate)
    {
        ...
        SCI_MEMSET((void *)&x_d[0], 0, (unsigned int)max_DN * 2);
        x_d_i = 25;
        ...
        int32_t       Fs)
    {
        ...
        int16_t  i = 0;
        SCI_MEMSET(recordeq_filter_set,0,sizeof(recordeq_filter_set));
        ...
        if (!RECORD_EQ_SW && !RECORD_EQ_STEREO) {
            SCI_TRACE_LOW("Warning: RECORD_EQ NOT init!!! %d %d %d",recordeq_param_ptr->RECORDEQ_sw_switch,
               RECORD_EQ_SW,RECORD_EQ_STEREO );
            return FALSE;
        }
...
void  AUDPROC_ProcessDp_2(
    ...
    )
    {
        ...
        if(!RECORD_EQ_STEREO) {
            ...
            memcpy((void *)psSrcRightData,(const void *)psSrcLeftData, (unsigned int)sizeof(int16_t)*uiSrcCount);
        } else {
