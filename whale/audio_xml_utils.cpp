...
{
    char *sub_name;
    unsigned int param_name_size=0;
    ...
    if(param_name_size>sizeof(path_name)){
        ...
        memcpy(path_name,param_name,sizeof(path_name)-1);
    }else{
...
int private_crate_group(param_group_t group, const char *ele_name,param_group_t new_group)
{
    char *str;

    char *str1;
    char *str2;
    TiXmlElement *ele1=NULL;;
    ...
    if(NULL!=str2){
        if(NULL!=str1){
            ele1=((TiXmlElement *)group)->FirstChildElement(str2);
            if(NULL==ele1){
                ele1=new TiXmlElement(str2);
                ((TiXmlElement *)group)->InsertEndChild(*ele1);
            }
            private_crate_group(ele1,str1,new_group);
        }else{
            ele1=(TiXmlElement *)((TiXmlElement *)group)->Clone();
            ((TiXmlElement *)group)->InsertEndChild(*ele1);
        }
    }else{
        ele1=(TiXmlElement *)((TiXmlElement *)group)->Clone();
