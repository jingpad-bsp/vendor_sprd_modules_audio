                       ...
                       UNUSED_ATTR int max_data_size)
{
    ...
    return _get_register_value(addr, size, (int *)data);
}

int set_register_value(const char *infor,UNUSED_ATTR int size)
{
